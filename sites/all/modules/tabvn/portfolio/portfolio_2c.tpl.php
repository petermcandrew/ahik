        ...
        <div class="portfolio-item-wrapper">
          <div class="column grid_6">
            ...
            <div class="cover boxcaption box_2">
              <div class="project-name"><h5><?php print custom_trim_text(array('max_length' => 100), $node->title); ?></h5></div>
              <div class="project-text">
                <?php print custom_trim_text(array('max_length' => 300, 'html' => true, 'ellipsis' => true), $node->body[LANGUAGE_NONE][0]['value']); ?>															
